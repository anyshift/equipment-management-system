...
public class UserDAOImpl implements UserDAO {
    ...
    public List<User> getWorkers() {
        ...
        try {
            Connection c = Util.getConnection();
            Statement s = c.createStatement();
            String sql = "select `id`, `username`, `real_name`, `user_type`, `user_text` from `t_user` where user_type = '维修工'";
            ResultSet rs = s.executeQuery(sql);
            while (rs.next()) {
                User user = new User();
                ...
                user.setUserText(rs.getString("user_text"));
                users.add(user);
            }
            rs.close();
            s.close();
    ...
    public List<User> getAllStaff() {
        ...
        try {
            Connection c = Util.getConnection();
            Statement s = c.createStatement();
            String sql = "select `id`, `username`, `real_name`, `user_type`, `user_text` from `t_user` where user_type = '普通员工'";
            ResultSet rs = s.executeQuery(sql);
            while (rs.next()) {
                User user = new User();
                user.setId(rs.getLong("id"));
